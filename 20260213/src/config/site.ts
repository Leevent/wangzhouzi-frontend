...
export const siteConfig = {
  name: '望周知',
  slogan: '希望每個人都能知道',
  description: '發掘台灣在地的優質資源與服務！從免費數位圖書館到正規大學課程，從政府便民服務到社會福利資源，我們整理這些珍貴資源，讓每個人都能輕鬆享受台灣的優質服務。',
  url: 'https://oldcity-frontend.zeabur.app',
  apiUrl: 'https://iwantyouknow.zeabur.app',

  // SEO 相關
  keywords: ['台灣', '資源', '政府服務', '教育', '民間組織', '免費資源', '數位學習', '社會福利'],
  author: '望周知團隊',
  ...
  navigation: {
    main: [
      ...
      { name: '外部資源', href: '/external-resources' },
      { name: '部落格', href: '/blog' },
