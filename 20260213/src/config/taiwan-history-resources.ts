...
export interface TaiwanHistoryResourceCategory {
  id: string;
  name: string;
  nameEn?: string;
  icon: string;
...
export const taiwanHistoryResources: TaiwanHistoryResourceCategory[] = [
  {
    id: 'digital-archives',
    name: '數位典藏',
  ...
  },
  {
    ...
    resources: [
      ...
      {
        name: '臺灣原住民族文化知識網',
        url: 'https://knowlegde.gov.taipei/',
        description: '收錄台灣原住民族群生活、文化、歷史、語言等相關資料',
        institution: '原住民族委員會',
        resourceType: 'database',
        tags: ['原住民', '文化', '語言', '傳統'],
        language: ['zh-TW'],
  ...
  },
  {
    ...
    resources: [
      ...
      {
        name: '日治時期統計資料庫',
        url: 'http://tcsd.lib.ntu.edu.tw/statistics/',
        description: '日治時期各類統計資料，涵蓋人口、經濟、教育等領域',
        institution: '國立臺灣大學',
        resourceType: 'database',
        tags: ['統計', '日治時期', '人口', '經濟'],
        language: ['zh-TW', 'ja'],
...
// 統計資訊
export const historyResourceStats = {
  totalCategories: taiwanHistoryResources.length,
  totalResources: taiwanHistoryResources.reduce((sum, cat) => sum + cat.resources.length, 0),
...
export default taiwanHistoryResources;
